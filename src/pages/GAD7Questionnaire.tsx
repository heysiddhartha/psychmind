...
export default function GAD7Questionnaire() {
  ...
  const handleNext = () => {
    ...
    if (currentQuestion < questions.length - 1) {
      ...
      navigate('/assessment-results', { state: { score: totalScore, type: 'GAD-7', max: 21 } });
    }
  };
  ...
  return (
    <>
      <Helmet>
        <title>GAD-7 Anxiety Assessment | psychmind</title>
        <meta name="description" content="Take the GAD-7 anxiety screening questionnaire" />
      </Helmet>
      <Layout>
                ...
                <div className="text-white lg:sticky lg:top-24">
                  ...
                  <div className="border-t-2 border-white/30 pt-6">
                    <p className="text-gray-200 leading-relaxed">
                      ...
                      how often have you been bothered by the following problems? Please 
